...
document.getElementById('MyButtonMinus').style.visibility='hidden';
document.getElementById('MyButtonPlus').style.visibility='hidden';


document.getElementById('soundOff').style.display='none';	

CatRandomAudio = new Audio('meow1.mp3');
CatMinusAudio = new Audio('meow2.mp3');
CatPlusAudio = new Audio('meow3.mp3');
...
document.getElementById('clickToGetFact').style.visibility='hidden';
...
$('#MyButtonPlus').click(function(){
if (randomNumber <=arraySize - 5 ){	
if (document.getElementById('myonoffswitch').checked) {
       CatPlusAudio.play(); 
}
